...
urlpatterns = [
    ...
    path(
        "bath-time/<int:pk>/",
        views.BathTimeUpdate.as_view(),
        name="bathtime-update",
    ),
    path(
    ...
    path("reflux/", views.RefluxList.as_view(), name="reflux-list"),
    path("reflux/add/", views.RefluxAdd.as_view(), name="reflux-add"),
    path(
        "reflux/<int:pk>/",
        views.RefluxUpdate.as_view(),
        name="reflux-update",
    ),
    path(
        "reflux/<int:pk>/delete/",
        views.RefluxDelete.as_view(),
        name="reflux-delete",
    ),
    path("food/", views.FoodList.as_view(), name="food-list"),
    path("food/add/", views.FoodAdd.as_view(), name="food-add"),
    path(
        "food/<int:pk>/",
